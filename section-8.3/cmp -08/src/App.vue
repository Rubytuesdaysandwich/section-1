...
<script>
/*While props depends on a specific parent-child relationship, the Provide/Inject API will inject data into the parent-child tree for any descendant to consume. */
//props should be your default go to for passing most things between components, if there is lots of pass through components provide and inject should be considered
export default {
  data() {
    return {
      topics: [
