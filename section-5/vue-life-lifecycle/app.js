const app = Vue.createApp({
  ...
  //!HOOKS▼▼▼▼▼▼▼▼
  beforeCreate() {
    console.log("beforeCreate()"); //nothing on screen at this point life cycle vue js
  },
  created() {
    console.log("created()"); //nothing on screen at this point life cycle vue js
  },
  beforeMount() {
    console.log("beforeMount()"); //nothing on screen at this point life cycle vue js
  },
  mounted() {
    console.log("mounted()"); //appears on screen at this cycle
  },
  beforeUpdate() {
